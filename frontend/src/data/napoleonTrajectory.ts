/**
 * Napoleon Bonaparte's simulated campaign trajectory data (1796–1815).
 *
 * Each waypoint represents a historically-inspired location and date
 * during Napoleon's major campaigns. The data is simplified for
 * visualization purposes — not a precise historical record.
 *
 * Campaigns covered:
 * - Italian Campaign (1796–1797)
 * - Egyptian Campaign (1798–1799)
 * - Rise to Power / Marengo (1799–1800)
 ...
 * Returns the lat/lng and surrounding waypoint info.
 */
export function interpolatePosition(timestamp: number): {
  ...
  // Show the nearest waypoint's info (snap to closer one)
